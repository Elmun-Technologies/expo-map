...
| Объекты с параметрами | Техническая комната · Грузовые ворота · Сцена · Зона семинаров и форума · Conference-Hall · Small Conference-Hall · 2× B2B · Переговорная · Винтовой выход · Выход к открытому павильону · Регистрация · Главный вход · 2× WC · Парковка | Показаны отдельными зонами |
...
## Примечание к версии 1.4.1

* Правый блок зала сжат по ширине (96 м → 84,5 м): B2B-зона, зона семинаров и конференц-зоны стали уже,
  за счёт этого план крупнее, а подписи стендов читаются заметно лучше (шрифты увеличены).
* У служебных помещений появилась вторая строка: площадь и вместимость (правила — в `meta.serviceRules`).
* Зоны B2B и семинаров тоже подписаны параметрами: «172 м² · до 60 мест», «184 м² · до 20 столов · 40 мест».
